...
export class Context {
    ...
    text_lines(s, x, y, w, h, align, line_height) {
        const { height } = canvas_text.drawText(this.ctx, s, {
            x, y, width: w, height: h,
            font: this.ctx.font,
            fontSize: this.font_size,
            align: this.ctx.textAlign,
            vAlign: align ?? this.ctx.textBaseline,
